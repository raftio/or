...
const EXTENSION_CONFIG = `{
  "orqestra.apiUrl": "${API_URL}",
  "orqestra.apiToken": "<paste-your-token-here>"
}`;
    ...
    <div className="space-y-6">
      <section>
        ...
        <p className="mt-2 text-sm leading-relaxed text-base-text-muted">
          Install the <strong>Orqestra</strong> extension from the VS Marketplace,
        ...
        <pre className="mt-2 overflow-x-auto rounded-lg bg-base p-3 text-xs font-mono text-base-text-muted">
          ...
          --install-extension vsc-orqestra-0.1.0.vsix
        </pre>
      </section>
      ...
      <section>
        ...
        <p className="mt-2 text-sm leading-relaxed text-base-text-muted">
          ...
          and search for <strong>Orqestra</strong>, or add to your{" "}
          <code className="rounded bg-base px-1.5 py-0.5 text-xs font-mono text-base-text">
            settings.json
          </code>
          :
      ...
      <section>
        ...
        <p className="mt-2 text-sm leading-relaxed text-base-text-muted">
          ...
          and run <strong>Orqestra: Fetch Bundle</strong>. Enter a Jira ticket ID
      ...
      <section>
        ...
        <ul className="mt-2 space-y-1.5 text-sm text-base-text-muted">
          <li>
            <code className="rounded bg-base px-1.5 py-0.5 text-xs font-mono text-base-text">
              Orqestra: Fetch Bundle
            </code>{" "}
            — load execution bundle for a ticket
          </li>
          <li>
            <code className="rounded bg-base px-1.5 py-0.5 text-xs font-mono text-base-text">
              Orqestra: Submit Evidence
            </code>{" "}
